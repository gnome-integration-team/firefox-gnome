//@line 62 "/builddir/build/BUILD/firefox-4.0.1/mozilla-2.0/browser/base/content/nsContextMenu.js"
...
//@line 243 "/builddir/build/BUILD/firefox-4.0.1/mozilla-2.0/browser/base/content/nsContextMenu.js"
    // Only enable Set as Desktop Background if we can get the shell service.
    var shell = getShellService();
    if (shell)
      haveSetDesktopBackground = true;
//@line 248 "/builddir/build/BUILD/firefox-4.0.1/mozilla-2.0/browser/base/content/nsContextMenu.js"
...
//@line 382 "/builddir/build/BUILD/firefox-4.0.1/mozilla-2.0/browser/base/content/nsContextMenu.js"
    // Copy image contents depends on whether we're on an image.
    this.showItem("context-copyimage-contents", this.onImage);
//@line 385 "/builddir/build/BUILD/firefox-4.0.1/mozilla-2.0/browser/base/content/nsContextMenu.js"
...
//@line 870 "/builddir/build/BUILD/firefox-4.0.1/mozilla-2.0/browser/base/content/nsContextMenu.js"
    // On non-Mac platforms, the Set Wallpaper dialog is modal.
    openDialog(kDesktopBackgroundURL, "",
               "centerscreen,chrome,dialog,modal,dependent",
               this.target);
//@line 875 "/builddir/build/BUILD/firefox-4.0.1/mozilla-2.0/browser/base/content/nsContextMenu.js"
  },
